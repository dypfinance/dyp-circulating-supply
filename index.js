...
const HOLDERS_LIST_BSC = [
	...
	"0xb75a04b0d88be0887fe726de1beda7532bca22b5",
	"0x14d48df8b7967de9dc04c0a78b3c85296388f48e",
...
const HOLDERS_AVAX_CONTRACTS = [
	...
	"0xe8413df8ebc4624f0f40d75fdefc3994e9318956",
	//dEaD
	"0x000000000000000000000000000000000000dead"
]
...
const HOLDERS_BSC_CONTRACTS = [
	...
	"0x910090ea889b64b4e722ea4b8ff6d5e734dfb38f",
	"0xb4657bd14ffc573528feb29d357a750d7543dd22",
	"0xb75a04b0d88be0887fe726de1beda7532bca22b5",//wod 
	"0x14d48df8b7967de9dc04c0a78b3c85296388f48e", //wod
	//Vesting
...
const IDs_constant_staking_idyp_eth = {
	...
	"0x41b8a58f4307ea722ad0a964966caa18a6011d93":
	{
		pool_name: "iDYP Constant Staking ETH",
		pair_name: "iDYP",
		link_pair: "https://app.dyp.finance/staking-idyp-5",
		return_types: "iDYP",
		lock_time: "60 days",
		expired: "Yes",
		new_pool: "No",
...
const IDs_constant_staking_idyp_avax = {
	...
	"0xe026fb242d9523dc8e8d8833f7309dbdbed59d3d":
	{
		pool_name: "iDYP Constant Staking AVAX",
		pair_name: "iDYP",
		link_pair: "https://app-avax.dyp.finance/staking-idyp-5",
		return_types: "iDYP",
		lock_time: "60 days",
		expired: "Yes",
		new_pool: "No",
...
let [stakingiDYPAvaxTvl15, stakingiDYPAvaxTvl20, stakingiDYPAvaxTvl30, stakingiDYPAvaxTvl45, stakingiDYPAvaxTvl25_3, stakingiDYPAvaxTvl20_3] = [0, 0, 0, 0, 0, 0]

let [stakingDYPAvaxTvl1, stakingDYPAvaxTvl2, stakingDYPAvaxTvl10, stakingDYPAvaxTvl25, stakingDYPAvaxTvl30, stakingDYPAvaxTvl50, stakingDYPAvaxTvl25_3] = [0, 0, 0,0, 0, 0, 0]
...
const IDs_User_Pools_ETH_VAULTS1 = {
	...
	"0xf4389cd022a0188035f366426364cc079695c436":
	{
		contract_address: "0xf4389cd022a0188035f366426364cc079695c436",
		tvl:""
	},
	"0x2e660644a5582d23ba274cf406488e18bcd55b06":
	{
		contract_address: "0x2e660644a5582d23ba274cf406488e18bcd55b06",
	},
	"0xfc569288c4297419b776c0bdfac677256e10da3f":
	{
	...
	{
		contract_address: "0xf656dc256c60eb8417366015ee9217462b5a795d",
	}
}
...
let TOKEN_ADDRESS_WETH_2 = "0xf4389cd022a0188035f366426364cc079695c436"
let TOKEN_ADDRESS_WBTC_2 = "0x2e660644a5582d23ba274cf406488e18bcd55b06"
let TOKEN_ADDRESS_USDC_2 = "0xfc569288c4297419b776c0bdfac677256e10da3f"
let TOKEN_ADDRESS_USDT_2 = "0xE39BEd1DeC2f97dA3aEb014a28170FE5fB66065F"
let TOKEN_ADDRESS_DAI_2 = "0xf656dc256c60eb8417366015ee9217462b5a795d"
...
let tvlvault9 = 0
let tvlvault10 = 0
let _tvlvaultWETH_2 = 0
let _tvlvaultWBTC_2 = 0
let _tvlvaultUSDC_2 = 0
let _tvlvaultUSDT_2 = 0
let _tvlvaultDAI_2 = 0
let tvlvault1_2 = 0
let tvlvault2_2 = 0
let tvlvault3_2 = 0
let tvlvault4_2 = 0
...
let token_contract_weth_2 = new infuraWeb3.eth.Contract(token_abi_weth, TOKEN_ADDRESS_WETH_2, { from: undefined })
let token_contract_wbtc_2 = new infuraWeb3.eth.Contract(token_abi_wbtc, TOKEN_ADDRESS_WBTC_2, { from: undefined })
let token_contract_usdt_2 = new infuraWeb3.eth.Contract(token_abi_usdt, TOKEN_ADDRESS_USDT_2, { from: undefined })
let token_contract_usdc_2 = new infuraWeb3.eth.Contract(token_abi_usdc, TOKEN_ADDRESS_USDC_2, { from: undefined })
let token_contract_dai_2 = new infuraWeb3.eth.Contract(token_abi_dai, TOKEN_ADDRESS_DAI_2, { from: undefined })
...
tvlvault1_2 = await token_contract_weth_2.methods.totalDepositedTokens().call()
tvlvault1_2 = tvlvault1_2 / 1e18 * ethPrice
tvlvault2_2 = await token_contract_idyp.methods.balanceOf(TOKEN_ADDRESS_WETH_2).call()
tvlvault2_2 = tvlvault2_2 / 1e18 * price_iDYP

_tvlvaultWETH_2 = tvlvault1_2 + tvlvault2_2

tvlvault3_2 = await token_contract_wbtc_2.methods.totalDepositedTokens().call()
tvlvault3_2 = tvlvault3_2 / 1e8 * wbtcPrice
tvlvault4_2 = await token_contract_idyp.methods.balanceOf(TOKEN_ADDRESS_WBTC_2).call()
tvlvault4_2 = tvlvault4_2 / 1e18 * price_iDYP

_tvlvaultWBTC_2 = tvlvault3_2 + tvlvault4_2

tvlvault5_2 = await token_contract_usdt_2.methods.totalDepositedTokens().call()
tvlvault5_2 = tvlvault5_2 / 1e6
tvlvault6_2 = await token_contract_idyp.methods.balanceOf(TOKEN_ADDRESS_USDT_2).call()
tvlvault6_2 = tvlvault6_2 / 1e18 * price_iDYP

_tvlvaultUSDT_2 = tvlvault5_2 + tvlvault6_2


tvlvault7_2 = await token_contract_usdc_2.methods.totalDepositedTokens().call()
tvlvault7_2 = tvlvault7_2 / 1e6
tvlvault8_2 = await token_contract_idyp.methods.balanceOf(TOKEN_ADDRESS_USDC_2).call()
tvlvault8_2 = tvlvault8_2 / 1e18 * price_iDYP

_tvlvaultUSDC_2 = tvlvault7_2 + tvlvault8_2

tvlvault9_2 = await token_contract_dai_2.methods.totalDepositedTokens().call()
tvlvault9_2 = tvlvault9_2 / 1e18
tvlvault10_2 = await token_contract_idyp.methods.balanceOf(TOKEN_ADDRESS_DAI_2).call()
tvlvault10_2 = tvlvault10_2 / 1e18 * price_iDYP

_tvlvaultDAI_2 = tvlvault9_2 + tvlvault10_2
...
const get_iDYP_Vault_TVL_Info = async () => {
	...
	for (let id of ids_constant_staking_eth) {
		...
		if(id == "0xf4389cd022a0188035f366426364cc079695c436")
			tvl_usd = _tvlvaultWETH_2

		if(id == "0x2e660644a5582d23ba274cf406488e18bcd55b06")
			tvl_usd = _tvlvaultWBTC_2
...
const updateStakingTVLAVAX = async () => {
	...
	let _tvliDYPAvax25_3 = await token_contract_avax_1.methods.balanceOf('0xe026fb242d9523dc8e8d8833f7309dbdbed59d3d').call()
	let _tvliDYPAvax25_3_2 = await token_contract_avax_2.methods.balanceOf('0xe026fb242d9523dc8e8d8833f7309dbdbed59d3d').call()
	_tvliDYPAvax25_3 = _tvliDYPAvax25_3 / 1e18 * usdPerToken
	_tvliDYPAvax25_3 = _tvliDYPAvax25_3 + _tvliDYPAvax25_3_2 / 1e18 * price_iDYP_eth
	stakingiDYPAvaxTvl25_3 = _tvliDYPAvax25_3;
	...
	let _tvpDYPAvax25_3 = await token_contract_avax_1.methods.balanceOf('0xdb2e1287aac9974ab28a66fabf9bcb34c5f37712').call()
	let _tvpDYPAvax25_3_2 = await token_contract_avax_2.methods.balanceOf('0xdb2e1287aac9974ab28a66fabf9bcb34c5f37712').call()
	_tvpDYPAvax25_3 = _tvpDYPAvax25_3 / 1e18 * usdPerToken
	_tvpDYPAvax25_3 = _tvpDYPAvax25_3 + _tvpDYPAvax25_3_2 / 1e18 * price_iDYP_eth
	stakingDYPAvaxTvl25_3 = _tvpDYPAvax25_3;

	totaltvlavax = stakingiDYPAvaxTvl15 + stakingiDYPAvaxTvl20 + stakingiDYPAvaxTvl30 + stakingDYPAvaxTvl25_3 + stakingiDYPAvaxTvl25_3 + stakingiDYPAvaxTvl45 + stakingDYPAvaxTvl1 + stakingDYPAvaxTvl2 + stakingDYPAvaxTvl10 + stakingDYPAvaxTvl25 + stakingDYPAvaxTvl30 + stakingDYPAvaxTvl50
...
const updateStakingTVLBNB = async () => {
	...
	let _tvliDYPBnb20_3 = await token_contract_bnb_1.methods.balanceOf('0x525cb0f6b5dae73965046bcb4c6f45ce74fb1b5d').call()
	let _tvliDYPBnb20_3_2 = await token_contract_bnb_2.methods.balanceOf('0x525cb0f6b5dae73965046bcb4c6f45ce74fb1b5d').call()
	...
	let _tvlDYPBnb25_3 = await token_contract_bnb_1.methods.balanceOf('0xc03cd383bbbd78e54b8a0dc2ee4342e6d027a487').call()
	let _tvlDYPBnb25_4 = await token_contract_bnb_2.methods.balanceOf('0xc03cd383bbbd78e54b8a0dc2ee4342e6d027a487').call()
	_tvlDYPBnb25_3 = _tvlDYPBnb25_3 / 1e18 * usdPerToken
	_tvlDYPBnb25_3 = _tvlDYPBnb25_3 + _tvlDYPBnb25_4 / 1e18 * price_iDYP_eth
	stakingDYPBnbTvl25_3 = _tvlDYPBnb25_3;

	totaltvlbsc = stakingiDYPBnbTvl15 + stakingiDYPBnbTvl20 + stakingiDYPBnbTvl30 + stakingiDYPBnbTvl45  +stakingiDYPBnbTvl20_3+ stakingDYPBnbTvl1 + stakingDYPBnbTvl25_3 + stakingDYPBnbTvl2 + stakingDYPBnbTvl10 + stakingDYPBnbTvl25 + stakingDYPBnbTvl30 + stakingDYPBnbTvl50;
...
const updateStakingTVLETH = async () => {
	...
	let _tvliDYPEth20_3 = await token_contract_eth_1.methods.balanceOf('0x41b8a58f4307ea722ad0a964966caa18a6011d93').call()
	let _tvliDYPEth20_3_2 = await token_contract_eth_2.methods.balanceOf('0x41b8a58f4307ea722ad0a964966caa18a6011d93').call()
	_tvliDYPEth20_3 = _tvliDYPEth20_3 / 1e18 * usdPerToken
	_tvliDYPEth20_3 = _tvliDYPEth20_3 + _tvliDYPEth20_3_2 / 1e18 * price_iDYP_eth
	stakingiDYPEthTvl20_3 = _tvliDYPEth20_3;
	...
	totaltvl = stakingiDYPEthTvl15 + stakingiDYPEthTvl20 + stakingiDYPEthTvl30 + stakingiDYPEthTvl45 + stakingiDYPEthTvl20_3 + stakingDYPEthTvl1 + stakingDYPEthTvl2 + stakingDYPEthTvl25 + stakingDYPEthTvl7 + cawsnfttvl + landnfttvl + landcawstvl
	return totaltvl,
...
const updateStakingTVLETH_NEW = async () => {
	...
	let token_contract_eth_new_2 = new infuraWeb3.eth.Contract(TOKEN_ABI, TOKEN_ADDRESS_IDYP, { from: undefined })
	...
	let _tvlDYPEth25_2 = await token_contract_eth_new_2.methods.balanceOf('0x92A84052Fe6945949A295AF14a7506e3dc085492').call()
	_tvlDYPEth25 = _tvlDYPEth25 + _tvlDYPEth25_2 / 1e18 * idyp_price_new
	stakingDYPETHNewTVL25 = _tvlDYPEth25;

	let _tvlDYPEth152 = await token_contract_eth_new_1.methods.balanceOf('0x0fafe78e471b52bc4003984a337948ed55284573').call()
	_tvlDYPEth152 = _tvlDYPEth152 / 1e18 * dyp_price_new
	stakingDYPETHNewTVL152 = _tvlDYPEth152;

	let _tvlDYPETH252 = await token_contract_eth_new_1.methods.balanceOf('0xFdD3CFF22CF846208E3B37b47Bc36b2c61D2cA8b').call()
	_tvlDYPETH252 = _tvlDYPETH252 / 1e18 * dyp_price_new
	let _tvlDYPETH252_2 = await token_contract_eth_new_2.methods.balanceOf('0xFdD3CFF22CF846208E3B37b47Bc36b2c61D2cA8b').call()
	_tvlDYPETH252 = _tvlDYPETH252 + _tvlDYPETH252_2 / 1e18 * idyp_price_new
	stakingDYPETHNewTVL252 = _tvlDYPETH252;


	totaltvl = totaltvl + stakingDYPETHNewTVL125 + stakingDYPETHNewTVL8 + stakingDYPETHNewTVL20 + stakingDYPETHNewTVL25 + stakingDYPETHNewTVL252 + stakingDYPETHNewTVL152;
	return totaltvl;
}
...
const get_iDYP_ETH_Staking_Info = async () => {
	...
	for (let id of ids_constant_staking_eth) {
		...
		if(id == "0x41b8a58f4307ea722ad0a964966caa18a6011d93")
			tvl_usd = stakingiDYPEthTvl20_3
...
const get_DYP_ETH_Staking_Info_New =  async () => {
	...
	for (let id of ids_constant_staking_eth) {
		...
		if(id == "0xFdD3CFF22CF846208E3B37b47Bc36b2c61D2cA8b")
			{
				tvl_usd = stakingDYPETHNewTVL252
				apy_percent = IDs_constant_staking_dyp_eth_new[id].apy
				apy_performancefee = IDs_constant_staking_dyp_eth_new[id].apy_performancefee
			}
		if(id == "0x0fafe78e471b52bc4003984a337948ed55284573"){
			tvl_usd = stakingDYPETHNewTVL152
			apy_percent = IDs_constant_staking_dyp_eth_new[id].apy
			apy_performancefee = IDs_constant_staking_dyp_eth_new[id].apy_performancefee
		}
...
const get_DYP_BNB_Staking_Info = async () => {
	...
	for (let id of ids_constant_staking_eth) {
		...
		if(id == "0xc03cd383bbbd78e54b8a0dc2ee4342e6d027a487") {
			tvl_usd = stakingDYPBnbTvl25_3
			apy_percent = IDs_constant_staking_dyp_bnb[id].apy
			apy_performancefee = IDs_constant_staking_dyp_bnb[id].apy_performancefee
		}
...
const get_DYP_AVAX_Staking_Info = async () => {
	...
	for (let id of ids_constant_staking_eth) {
		...
		if(id == "0xdb2e1287aac9974ab28a66fabf9bcb34c5f37712")
		{
			tvl_usd = stakingDYPAvaxTvl25_3
			apy_percent = IDs_constant_staking_dyp_avax[id].apy
			apy_performancefee = IDs_constant_staking_dyp_avax[id].apy_performancefee
		}
...
const IDs_User_Pools_BSC_IDYP = {
	...
	"0x525cb0f6b5dae73965046bcb4c6f45ce74fb1b5d":
	{
		contract_address: "0x525cb0f6b5dae73965046bcb4c6f45ce74fb1b5d",
	}
}
...
const IDs_User_Pools_ETH_IDYP = {
	...
	"0x41b8a58f4307ea722ad0a964966caa18a6011d93":
	{
		contract_address: "0x41b8a58f4307ea722ad0a964966caa18a6011d93",
	}
}
...
const IDs_User_Pools_ETH_DYP = {
	...
	"0x998A9F0DF7DAF20c2B0Bb379Dcae394636926a96":
	{
		contract_address: "0x998A9F0DF7DAF20c2B0Bb379Dcae394636926a96",
	},
	"0xbE030A667d9ee75a9FCdF2162A2C14ccCAB573dD":
	{
		contract_address: "0xbE030A667d9ee75a9FCdF2162A2C14ccCAB573dD",
	},
	"0x92A84052Fe6945949A295AF14a7506e3dc085492":
	{
		contract_address: "0x92A84052Fe6945949A295AF14a7506e3dc085492",
	},
	"0xFdD3CFF22CF846208E3B37b47Bc36b2c61D2cA8b":
	{
		contract_address: "0xFdD3CFF22CF846208E3B37b47Bc36b2c61D2cA8b",
	},

	"0x0fafe78e471b52bc4003984a337948ed55284573":
	{
		contract_address: "0x0fafe78e471b52bc4003984a337948ed55284573",
	},
...
const IDs_User_Pools_AVAX_IDYP = {
	...
	"0xe026fb242d9523dc8e8d8833f7309dbdbed59d3d":
	{
		contract_address: "0xe026fb242d9523dc8e8d8833f7309dbdbed59d3d",
	},
}
...
let DYP_NEW_ADDRESS_BNB = '0x1a3264F2e7b1CFC6220ec9348d33cCF02Af7aaa4'
const DYP_NEW_ADDRESS_AVAX = '0x1a3264F2e7b1CFC6220ec9348d33cCF02Af7aaa4'; 
const DYP_NEW_ADDRESS_ETH = '0x39b46B212bDF15b42B166779b9d1787A68b9D0c3';
...
async function newIdypPrice() {
	await fetch('https://pro-api.coingecko.com/api/v3/simple/price?ids=idefiyieldprotocol&vs_currencies=usd&x_cg_pro_api_key=CG-4cvtCNDCA4oLfmxagFJ84qev')
	.then(response => response.json())
		...
		return idyp_price_new;
}


const IDs_constant_staking_mobile_dyp_eth = {
    "0": [
        {
            contract_address: "0xC9075092Cc46E176B1F3c0D0EB8223F1e46555B0",
            apr_percent: 12.5,
...
const IDs_constant_staking_mobile_dyp_bnb = {
    "0": [
        {
            contract_address: "0x8cee06119fffecdd560ee83b26cccfe8e2fe6603",
            apr_percent: 12.5,
...
const IDs_constant_staking_mobile_dyp_avax = {
    "0": [
        {
            contract_address: "0x8cee06119fffecdd560ee83b26cccfe8e2fe6603",
            apr_percent: 12.5,
...
const IDs_constant_staking_mobile_idyp_eth = {
    "60": [
        {
            contract_address: "0x41b8a58f4307ea722ad0a964966caa18a6011d93",
            apr_percent: 20,
...
const IDs_constant_staking_mobile_idyp_bnb = {
    "60": [
        {
            contract_address: "0x525cb0f6b5dae73965046bcb4c6f45ce74fb1b5d",
            apr_percent: 20,
...
const IDs_constant_staking_mobile_idyp_avax = {
    "60": [
        {
            contract_address: "0xe026fb242d9523dc8e8d8833f7309dbdbed59d3d",
            apr_percent: 20,
...
function aggregateStakingData() {
    const allData = {
        IDs_constant_staking_mobile_dyp_eth,
		IDs_constant_staking_mobile_dyp_bnb,
		IDs_constant_staking_mobile_dyp_avax,
		IDs_constant_staking_mobile_idyp_eth,
		IDs_constant_staking_mobile_idyp_bnb,
		IDs_constant_staking_mobile_idyp_avax,
    };

    let aggregatedData = {};

    Object.entries(allData).forEach(([key, pools]) => {
        const token = key.split('_')[4]; 
		console.log(token)
...
async function getPoolDetails(token, chain, lockTime) {
    const allData = {
        IDs_constant_staking_mobile_dyp_eth,
        IDs_constant_staking_mobile_dyp_bnb,
        IDs_constant_staking_mobile_dyp_avax,
    ...
    const poolsForLockTime = pools[lockTime];
    if (!poolsForLockTime) {
        return null; 
    }

    await Promise.all(poolsForLockTime.map(async (pool) => {
        await newDypPrice();
        let tvl_usd = 0;

        let tokenContractDYP, tokenContractIDYP, web3Instance;
        let dypAddress;

        if (chain === 'eth') {
            web3Instance = infuraWeb3;
            dypAddress = DYP_NEW_ADDRESS_ETH;
        } else if (chain === 'bnb') {
            web3Instance = bscWeb3;
            dypAddress = DYP_NEW_ADDRESS_BNB;
        } else if (chain === 'avax') {
            web3Instance = avaxWeb3;
            dypAddress = DYP_NEW_ADDRESS_AVAX;
        }

        if (web3Instance && dypAddress) {
            tokenContractDYP = new web3Instance.eth.Contract(TOKEN_ABI, dypAddress, { from: undefined });
            tokenContractIDYP = new web3Instance.eth.Contract(TOKEN_ABI, TOKEN_ADDRESS_IDYP, { from: undefined });

            try {
                console.log(`Fetching balances for pool address: ${pool.contract_address}`);
                const token_balance = await tokenContractDYP.methods.balanceOf(pool.contract_address).call();
                const token_balance1 = await tokenContractIDYP.methods.balanceOf(pool.contract_address).call();
                tvl_usd = (token_balance * dyp_price_new + token_balance1 * idyp_price_new) / 1e18;
            } catch (error) {
                pool.tvl_usd = 0; 
                return;
            }
...
app.get('/api/mobile/staking/:token/:chain/:lockTime', async (req, res) => {
    ...
    try {
        const poolDetails = await getPoolDetails(token, chain, lockTime);
        if (poolDetails) {
