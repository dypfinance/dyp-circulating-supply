...
async function update_token_balance_sum_bsc() {
	...
	let circulating_supply_eth = new BigNumber(281413839).minus(token_balance_sum_idyp_eth) //bridge
	...
	circulating_supply_idyp = new BigNumber(300000000).minus(41424547).minus(token_balance_sum_idyp).plus(circulating_supply_eth).plus(circulating_supply_avax);
